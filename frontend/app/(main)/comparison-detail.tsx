    ...
    <View style={styles.container}>
      ...
      >
        ...
        {activeSection === 3 && (
          <View>
            {[
              { key: 'family', label: 'Family Trip', icon: 'people', color: '#F5A623' },
              { key: 'business', label: 'Business', icon: 'briefcase', color: '#2193b0' },
              { key: 'friends', label: 'Friends', icon: 'beer', color: '#a78bfa' },
...
const styles = StyleSheet.create({
  ...
  tabBar: { backgroundColor: 'rgba(255,255,255,0.06)', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' },
  tabScroll: { paddingHorizontal: 15, gap: 8 },
  tabBtn: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 20, backgroundColor: '#0f0c29' },
  ...
  card: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 18, padding: 16, marginBottom: 14,  },
  cardTitle: { fontSize: 16, fontWeight: '700', color: '#fff', marginBottom: 4 },
  cardSub: { fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 14 },
  // Ratings
  ratingBlock: { marginBottom: 16 },
  ratingLabel: { fontSize: 13, fontWeight: '700', color: '#fff', marginBottom: 8 },
  ...
  overallCard: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 18, padding: 16, marginTop: 4,  },
  ...
  overallName: { fontSize: 11, fontWeight: '600', color: 'rgba(255,255,255,0.6)', maxWidth: 80, textAlign: 'center' },
  starRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  starText: { fontSize: 12, fontWeight: '600', color: '#fff' },
  // Prices
  ...
  priceCompName: { fontSize: 12, fontWeight: '600', color: '#fff', flex: 1 },
  priceBarWrap: { flex: 1 },
  ...
  platformCard: { width: (width - 72) / 2, backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', alignItems: 'center' },
  ...
  // Features
  featureHeaderRow: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)', paddingBottom: 10, marginBottom: 4 },
  ...
  featureHotelName: { fontSize: 10, fontWeight: '600', color: 'rgba(255,255,255,0.6)' },
  featureRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' },
  featureRowAlt: { backgroundColor: 'rgba(255,255,255,0.03)' },
  featureLabel: { fontSize: 13, color: '#fff', fontWeight: '500' },
  featureSummary: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16, paddingTop: 14, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)' },
  featureSummaryItem: { alignItems: 'center' },
  featureSummaryCount: { fontSize: 18, fontWeight: '800' },
  featureSummaryLabel: { fontSize: 11, color: 'rgba(255,255,255,0.4)' },
  // Trip Match
  tripCard: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 18, padding: 16, marginBottom: 12,  },
  ...
  tripLabel: { fontSize: 15, fontWeight: '700', color: '#fff' },
  tripRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  tripHotelName: { fontSize: 12, fontWeight: '500', color: 'rgba(255,255,255,0.6)', width: 80 },
  tripBarWrap: { flex: 1 },
